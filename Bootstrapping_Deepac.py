...
# ---------------------------------------------------------
THRESHOLDS = {
    "ORIGINAL SEQUENCES": 0.6131,
    "REVERSE COMPLEMENT": 0.5980,
    "SIMULATED SEQUENCES": 0.5879
}
...
if __name__ == "__main__":
    ...
    # ORIGINAL
    # -----------------------------------------------------
    y_scores_kmer = np.load("/home/family/Videos/deepac/kmer/kmer_deepac.txt.npy")

    y_kmer = load_pkl("/home/family/Videos/deepac/kmer/y_kmer.pkl")

    # -----------------------------------------------------
    # SIMULATED
    # -----------------------------------------------------
    y_scores_sim = np.load("/home/family/Videos/deepac/kmer/sim_deepac.txt.npy")

    y_sim = np.load("/home/family/Videos/eval/strain level/path_test/y_valid.npy")
    

    # -----------------------------------------------------
    # REVERSE COMPLEMENT
    # -----------------------------------------------------
    rev_y_scores = load_pkl("/home/family/Videos/deepac/kmer/Rev_kmer_deepac.pkl")
    rev_y = load_pkl("/home/family/Videos/deepac/kmer/y_kmer.pkl")
    ...
    output_csv = (
        ...
        "deepac_bootstrap_metrics_results_stratified.csv"
    )

    output_excel = (
        "/home/family/Videos/bootstrap/"
        "deepac_bootstrap_metrics_results_stratified.xlsx"
    )
